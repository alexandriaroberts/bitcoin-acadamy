        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-6'>
          <Card className='p-6 bg-slate-700 border-none'>
            <div className='flex items-center mb-4'>
              ...
              <Tooltip content='Your private key must be kept secret. Anyone with your private key can spend your bitcoin.'>
          ...
          <Card className='p-6 bg-slate-700 border-none'>
            <div className='flex items-center mb-4'>
              ...
              <Tooltip content="Your public key can be safely shared. It's used to verify signatures and generate addresses.">
                <Button variant='secondary' className='ml-2 p-0 h-6 w-6'>
                  <Info className='h-4 w-4' />
                </Button>
              </Tooltip>
          ...
          >
            ...
            <ul className='space-y-3'>
              ...
              <li className='flex items-start'>
                <span className='text-yellow-400 mr-2'>•</span>
                <span>
                  Your public key is mathematically derived from your private
            ...
            <div className='mt-6 bg-slate-800 p-4 rounded-md'>
              <p className='text-sm italic'>
                <strong>Important:</strong> In a real Bitcoin wallet, your
                private key would be used to generate a 12 or 24-word recovery
                phrase. This phrase is easier to back up than the raw private
                key, but serves the same purpose.
              </p>
            </div>
          </motion.div>
        )}
