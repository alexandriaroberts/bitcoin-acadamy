...
import { BitcoinLogo2D } from '../2d/bitcoin-logo';
        ...
        <Card className='bg-gradient-to-br from-slate-800 to-slate-900 text-white mt-8 border border-orange-500/20'>
          ...
          <ul className='space-y-3 text-sm'>
            <li className='flex items-start'>
              ...
              <span>
                The transaction data (sender, recipient, amount) is hashed using
                SHA-256.
              </span>
            </li>
            <li className='flex items-start'>
              <span className='text-orange-400 mr-2'>•</span>
              <span>
                Your private key is used to create a unique signature for this
                hash.
              </span>
            </li>
            <li className='flex items-start'>
              <span className='text-orange-400 mr-2'>•</span>
              <span>
                The signature proves you authorized this specific transaction
            ...
            <li className='flex items-start'>
              <span className='text-orange-400 mr-2'>•</span>
              <span>
                The signature is mathematically linked to both the transaction
                data and your key pair.
              </span>
            </li>
          </ul>
          <div className='mt-6 bg-slate-700 p-4 rounded-md border border-green-500/20'>
            <p className='text-sm italic text-green-400'>
              <strong>Security Note:</strong> Even if someone intercepts your
              signed transaction, they cannot modify it or create new
