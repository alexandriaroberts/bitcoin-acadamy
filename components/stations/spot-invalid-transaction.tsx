    ...
    <TooltipProvider>
      <div className='space-y-6'>
        <div>
          ...
          <p className='text-lg'>
            Now that you understand how signatures work, can you identify which
            of these transactions has an invalid signature?
          </p>
        </div>
        ...
        <div className='bg-slate-700 p-6 rounded-lg mt-6'>
          <div className='flex items-center mb-6'>
            ...
            <Tooltip content="Look carefully at the signature format. Valid Bitcoin signatures start with '3045'. An invalid signature might have a different prefix or structure that doesn't match the sender's key.">
              <Button variant='secondary' className='ml-2 p-0 h-6 w-6'>
          ...
          >
                ...
                <div>
                  ...
                  <div className='mt-3 p-3 bg-slate-900 rounded-md'>
                    ...
                    <ol className='text-xs text-slate-300 list-decimal ml-5 mt-1 space-y-1'>
                      ...
                      <li>
                        The signature was mathematically created using the
                        private key associated with the sender's address
                      </li>
                      <li>
            ...
            <ul className='space-y-2'>
              <li className='flex items-start'>
                ...
                <span>
                  Every node in the network independently verifies all
              ...
              <li className='flex items-start'>
                <span className='text-yellow-400 mr-2'>•</span>
                <span>
                  The system is trustless - you don't need to trust any
                  individual node because the math proves ownership.
                </span>
              </li>
            </ul>
